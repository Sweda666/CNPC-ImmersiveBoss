...
@Pseudo
@Mixin(targets = "yesman.epicfight.api.collider.MultiCollider", remap = false)
public abstract class MixinEpicFightMultiCollider {
    @Redirect(method = "updateAndSelectCollideEntity",
        at = @At(value = "INVOKE",
